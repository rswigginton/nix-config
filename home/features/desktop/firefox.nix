...
in {
  options.features.desktop.firefox.enable = mkEnableOption "enable firefox with extensions";
  ...
  config = mkIf cfg.enable {
    programs.firefox = {
      ...
      policies = {
        ...
        DisablePocket = true;
        DisableFirefoxAccounts = false; # Keep enabled for sync
        ...
        # Extensions via policies - using latest URLs that auto-update
        ExtensionSettings = {
          # uBlock Origin
        ...
        Preferences = {
          ...
          # UI preferences
          "browser.startup.page" = { Value = 3; Status = "locked"; }; # Restore previous session
